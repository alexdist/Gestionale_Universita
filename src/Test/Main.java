...
public class Main {
   /* public static void main(String[] args) {
        Client.Studente.StudenteClient client = new Client.Studente.StudenteClient("127.0.0.1", 12345);
        Client.Studente.MenuStudente menu = new Client.Studente.MenuStudente(client);
        menu.mostraMenu();
    }*/
